...
import { ContextManager, GitAutomation, createComponentLogger } from '@testmind/core';
...
export class InteractiveSession {
  ...
  private async initialize(): Promise<void> {
    ...
    if (!config) {
      throw new Error('TestMind is not initialized in this project. Run "testmind init" first.');
    }
