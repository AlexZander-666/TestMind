...
import type { SkillContext as SharedSkillContext, SkillMetadata as SharedSkillMetadata } from '@testmind/shared';
 ...
 * Aligned with shared SkillContext definition for cross-package compatibility.
 */
export type SkillContext = SharedSkillContext;
...
export interface Skill {
  ...
  /** Optional metadata when originating from TestSkill contracts */
  readonly metadata?: SharedSkillMetadata;
