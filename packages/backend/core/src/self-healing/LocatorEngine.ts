...
export class LocatorEngine {
  private readonly config: Required<Omit<LocatorEngineConfig, 'llmService'>> & { llmService?: LLMService };
  private readonly idLocator: IdLocator;
  private readonly cssLocator: CssSelectorLocator;
  private readonly xpathLocator: XPathLocator;
  private readonly visualLocator: VisualLocator;
  private readonly semanticLocator?: SemanticLocator;
